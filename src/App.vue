...
<template>
  ...
  <div id="app">
    <div class="button-group">
      ...
      <button id="trendlinebutton">Trendline</button>
    ...
    <div class="dropdown-container">
      <label class="dropdown-label" for="indicatorDropdown">Select a Financial Indicator:</label>
      <select id="indicatorDropdown" multiple>
...
import { DataLoader, rsi_indicator, bb_indicator } from "./dataLoader.js";
...
el("indicatorDropdown").addEventListener('click', () => {
